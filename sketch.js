...
function preload(){
  //preload the images and the files
...
function setup() {
  ...
  //scale the restart and gameOver
  gameOver.scale = 0.5;
  restart.scale = 0.5;

  //make the game over and restart sprite invisible
  ...
  //create the cloud and obstacle group
...
function draw() {
  ...
  //add the condition to that what will happen inside play
  if (gameState===PLAY){
  ...
  //add the conditions in the else
